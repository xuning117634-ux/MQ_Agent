...
用法：echo '{"topic_name":"T_test_001"}' | python publish_topic.py
"""
import json
import os
import sys
...
API_URL = "https://apigw-beta.huawei.com/api/beta/mqs/publications"
...
def publish_topic(topic_name: str) -> dict:
    if not topic_name:
